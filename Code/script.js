...
function reset(){
    ...
    document.getElementById('node1').style.backgroundColor = 'rgb(255, 0, 0)';
    document.getElementById('node100').style.backgroundColor = 'rgb(128, 0, 128)';
...
function solveMaze(){
    ...
    for(var i = 0; i < len; i++){
        visted[i] = new Array(len).fill(false);
    }
    ...
    while(queue.length > 0){
        ...
        visted[nodeCoor[0]][nodeCoor[1]] = true;
